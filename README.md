...
It simply demonstrates the idea of using AutoEncoders for denoising purposes at its simplest way: An AutoEncoder trained in a self-supervised manner, fed with Original Images + random noise, and enforced to recontruct original photos.
